<?php require_once __DIR__ . '/../../mohawk-vip-portal/vendor/engaged-nation/portal-core/FrontEnd/Bootstrap/client-front-end.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>VIP Preferred at Akwesasne Mohawk Casino</title>
    <?php require_once __DIR__ . '/../../mohawk-vip-portal/vendor/engaged-nation/portal-core/GoogleTagManager/Resources/public/gtm.php'; ?>
    ...
    <script async defer src="https://tools.luckyorange.com/core/lo.js?site-id=af95f271"></script>
</head>
<body>
    ...
    <script src="//<?php echo $enConfigClient['environment']['site_portal']; ?>/lib/js/engage.php?client_name=mohawk-vip&client_id=114974c6a835b99a4913f16d6ca2db49" type="text/javascript"></script>
